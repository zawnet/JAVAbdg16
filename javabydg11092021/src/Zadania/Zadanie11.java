...
public class Zadanie11 {
    public static void main(String[] args) {
        System.out.println("Podaj liczebe w postaci szestnastkowej: ");
        Scanner input = new Scanner(System.in);
        String number = input.nextLine();

        System.out.println("Postać binarna liczby: "+ convertHexToBinary(number));
    }

    private static String convertHexToBinary(String number) {
        // 2A5
